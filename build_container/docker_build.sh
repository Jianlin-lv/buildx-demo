...
#docker buildx create --use --name multi-builder --platform linux/arm
...
docker buildx build --platform linux/arm64  --push -f ${SCRIPTS_DIR}/../Dockerfile.llvm . -t ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/cilium-llvm:${IMAGE_TAG}-qemu-gh
#docker buildx build --platform linux/arm  --push -f ${SCRIPTS_DIR}/../Dockerfile.llvm . -t ${DOCKER_REGISTRY}/${DOCKER_REPOSITORY}/cilium-llvm:${IMAGE_TAG}-arm32
